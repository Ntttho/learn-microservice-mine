...
public class ProductController {
    ...
    private final com.session06.product_service.client.CategoryFeignClient categoryFeignClient;
    ...
    public ResponseEntity<com.session06.product_service.dto.ProductDetailResponse> getProductDetail(@PathVariable Long id) {
        return productService.getProductById(id)
                .map(prod -> {
                    com.session06.product_service.dto.CategoryDto catDto = null;
                    ...
                    com.session06.product_service.dto.ProductDetailResponse res = com.session06.product_service.dto.ProductDetailResponse.builder()
                            .id(prod.getId())
                            .name(prod.getName())
                            .price(prod.getPrice())
